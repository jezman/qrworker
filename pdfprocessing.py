    ...
    with open(filename, 'rb') as in_f:
        ...
        for num_page in range(num_pages):
            ...
            for column in range(columns):
                coordinates['y_top'] = get_coordinations(rows)['y_top']
                coordinates['y_bottom'] = get_coordinations(rows)['y_bottom']
